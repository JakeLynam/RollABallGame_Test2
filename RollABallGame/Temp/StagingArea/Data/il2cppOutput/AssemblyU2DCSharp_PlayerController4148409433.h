...
public:
	...
	float ___speed_2;
	// UnityEngine.UI.Text PlayerController::counterText
	Text_t356221433 * ___counterText_3;
...
public:
	...
	inline static int32_t get_offset_of_counterText_3() { return static_cast<int32_t>(offsetof(PlayerController_t4148409433, ___counterText_3)); }
	inline Text_t356221433 * get_counterText_3() const { return ___counterText_3; }
	inline Text_t356221433 ** get_address_of_counterText_3() { return &___counterText_3; }
	inline void set_counterText_3(Text_t356221433 * value)
	{
		___counterText_3 = value;
		Il2CppCodeGenWriteBarrier(&___counterText_3, value);
	}
